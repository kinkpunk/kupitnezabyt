...
- периодические проверки товаров, категорий и наборов;
...
MVP готов, когда пользователь может открыть Mini App из Telegram, создать категории и товары, менять их статусы, получать автоматически сформированный список покупок и напоминания, проходить проверку категории и экспортировать свои данные.

Подробные критерии приемки находятся в `docs/PRODUCT_SPEC.md`.
