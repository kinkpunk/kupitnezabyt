...
`docs/IMPLEMENTATION_ROADMAP.md`: явную точку входа “Поделиться”, понятный UX
для приглашения существующих пользователей, двухаккаунтный smoke на production
и beta-ограничения в интерфейсе.
