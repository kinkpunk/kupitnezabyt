...
- production deployment smoke для email magic link auth с реальным email
  provider и HTTPS browser URL;
- проверку production-safe browser auth без dev auth на deployed окружении;
