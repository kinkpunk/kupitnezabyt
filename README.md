...
- foundation совместных списков: workspace API, приглашения по email,
  переключение активного списка и управление участниками в настройках.
...
- совместные списки считаются post-MVP hardening track: базовый UX и API
  реализуются после core MVP, а privacy/export/deletion правила закрываются
  отдельным hardening slice.
...
- полноценные семейные аккаунты с ownership transfer, member removal и
  расширенными privacy/export правилами;
- подписки и платежи;
